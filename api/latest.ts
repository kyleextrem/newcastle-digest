/**
 * GET /api/latest
 * Fetches the latest published post from Beehiiv and returns title, url, publish_date.
 * API key and publication ID are server-only env vars. Response cached 5 minutes.
 */
