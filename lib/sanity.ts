...
export const postBySlugQuery = `*[_type == "post" && slug.current == $slug && defined(publishedAt)][0] {
  ${postFields},
  body
}`

export const postSlugsQuery = `*[_type == "post" && defined(slug.current) && defined(publishedAt)]{ "slug": slug.current }`
...
export const sitemapPostsQuery = `*[_type == "post" && defined(slug.current) && defined(publishedAt)]{
  "slug": slug.current,
