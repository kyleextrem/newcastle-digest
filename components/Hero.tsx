      ...
      <div className="relative w-full max-w-6xl mx-auto px-4 md:px-8 py-16 md:py-24">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-5xl mx-auto mb-14 md:mb-16">
            ...
            <p className="font-sans-main text-lg md:text-xl text-[#251f18]/55 mt-5 max-w-3xl mx-auto leading-relaxed">
              Newcastle Digest is Newcastle's independent weekly guide to what's happening across the city, covering events, food, live music, sport, culture, history, local stories and the things worth knowing about.
            </p>
          </div>
